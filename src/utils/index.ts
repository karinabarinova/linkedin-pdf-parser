...
export const languageLevel: string[] = ['(Native or Bilingual)', '(Full Professional)', '(Professional Working)', '(Elementary)', '(Limited Working)']
...
export function isExperienceFull(experience: ICompanyPositionStructure, currentDuration: string | null, currentPeriod: string | null, currentPosition: string | null) {
